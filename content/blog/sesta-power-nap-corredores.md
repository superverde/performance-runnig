...
faqs:
  - q: "Qual a duração ideal de uma sesta para corredores?"
    a: "A sesta ideal varia entre 20 e 30 minutos; períodos mais curtos (≤20 min) evitam a inercia do sono, enquanto 30 min permitem um ligeiro aprofundamento sem atrasar a recuperação noturna."
...
| Situação | Duração recomendada | Timing | Observações |
|----------|---------------------|--------|-------------|
| Pós‑treino de velocidade (intervalos, fartlek) | 20 min | 1–2 h após o treino | Evita o pico de cortisol, favorece a recuperação neuromuscular. |
| Treino de resistência (long run, tempo run) | 20–30 min | 2–4 h após o treino | Ajuda a restaurar glicogênio muscular e a reduzir a inflamação. |
| Treino de força (cross‑training) | 30 min | 3–5 h após o treino | Permite a síntese proteica sem interferir com o sono noturno. |
| Recuperação pós‑competição | 30 min | 2 h após a prova | Minimiza a dor muscular tardia e acelera a reposição de energia. |
