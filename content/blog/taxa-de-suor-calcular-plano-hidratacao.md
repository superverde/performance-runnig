...
faqs:
  - q: "Qual é a melhor forma de medir a taxa de suor de forma prática?"
    a: "Pesando antes e depois de cada treino, dividindo a perda de peso pelo tempo de exercício, e ajustando pela temperatura ambiental."
  - q: "Devo usar água ou bebidas isotónicas em todas as corridas?"
    a: "Para distâncias superiores a 60 min ou em temperaturas acima de 25 °C, recomenda‑se bebidas isotónicas com 6‑8 g L⁻¹ de sódio; em distâncias menores, água pura pode ser suficiente."
  - q: "É seguro beber mais líquidos do que a taxa de suor indica?"
    a: "Não. Excesso de líquidos pode causar hiponatremia; ajuste sempre a ingestão para corresponder à perda real de fluidos e eletrólitos."
---
...
1. **Pesagem**: pese‑se em roupa leve, de preferência antes de comer ou beber, e repita 10 min após a corrida.  
2. **Cálculo**:  
   \[
   \text{Taxa de suor (mL min⁻¹)} = \frac{\text{Perda de peso (g)}}{\text{Tempo de exercício (min)}}
   \]  
   Exemplo: perda de 1,2 kg em 90 min → 12 g min⁻¹ = 12 mL min⁻¹.  
3. **Ajuste de temperatura**: se a temperatura média do percurso for 28 °C, aumente a ingestão em 0,5 mL min⁻¹ por grau acima de 20 °C.  Para 8 °C acima de 20 °C, adicione 4 mL min⁻¹: 12 + 4 = 16 mL min⁻¹.

### 2. Construção do Plano de Hidratação

| Etapa | Objetivo | Quantidade | Frequência |
|-------|----------|------------|------------|
| Pré‑treino | Reabastecer 5 % do peso corporal | 0,5 L | 2 h antes |
| Durante | Substituir 100 % da perda de líquidos | 16 mL min⁻¹ | a cada 20 min |
| Pós‑treino | Reidratar 100 % da perda total | 1,2 L | 30 min após |
...
|------|--------------|---------|
| Ignorar a perda de peso antes de medir | Subestimação da taxa de suor | Pese sempre antes e depois |
| Usar apenas água | Hiponatremia em treinos >60 min | Adicionar eletrólitos |
| Ajustar a ingestão apenas por distância | Falha em considerar temperatura | Ajuste a taxa por grau Celsius |
| Não reidratar corretamente | Diminuição de desempenho em provas seguintes | Reabastecer 100 % da perda |
...
1. **Preparação**: pesagem, cálculo da taxa de suor, definição de objetivos de hidratação.  
2. **Execução**: ingestão de líquidos e eletrólitos conforme protocolo, monitorização em tempo real.  
3. **Revisão**: após cada treino, comparar perda de peso com volume ingerido e ajustar o protocolo.  
...
2. Maughan, R. J., & Shirreffs, S. M. (2010). Dehydration and rehydration in competitive sport. Scandinavian Journal of Medicine & Science in Sports, 20(s3), 40-47. https://doi.org/10.1111/j.1600-0838.2010.01207.x  
...
4. Burke, L. M., Hawley, J. A., Wong, S. H., & Jeukendrup, A. E. (2011). Carbohydrates for training and competition. Journal of Sports Sciences, 29(sup1), S17-S27. https://doi.org/10.1080/02640414.2011.585473
