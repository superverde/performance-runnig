...
1. **Determinar a FCmáx real** através de teste incremental máximo ou a partir dos valores de campo em provas de 5–10 km com esforço máximo na parte final.
2. **Definir zonas baseadas em limiares fisiológicos**, não em percentagens fixas da FCmáx.
3. **Utilizar sensor de peito** para todas as sessões de qualidade; aceitar PPG apenas para corridas de base e de recuperação.
4. **Registar a FC de repouso matinal** diariamente para monitorizar a recuperação.
5. **Interpretar a FC no contexto ambiental**: em dias quentes ou de maior humidade, aceitar ritmos mais lentos para manter as mesmas zonas de FC.
...
Stisen, A. B., Stougaard, O., Langberg, H., Wanscher, J., Kristiansen, B. H., & Aarts, A. A. (2021). Real-world accuracy of wrist-worn optical heart rate monitors during physical exercise. *Journal of Medical Internet Research mHealth and uHealth*, 9(2), e23454. https://doi.org/10.2196/23454
...
Cassirame, J., Tordi, N., Fabre, N., Duc, S., Durand, F., & Mourot, L. (2015). Heart rate variability to assess ventilatory threshold in ski-mountaineering. *European Journal of Sport Science*, 15(7), 615–622. https://doi.org/10.1080/17461391.2015.1004373
