...
export const PROVAS: Prova[] = [
  ...
  {
    nome: '48.ª Meia Maratona de São João das Lampas',
    dataInicio: '2026-09-12',
    local: 'Sintra',
    regiao: 'Lisboa',
    tipo: 'Estrada',
    distancias: ['21km', '13km'],
    link: 'https://lap2go.com/pt/event/mm-sao-joao-das-lampas-2026/regulamento.html',
    desc: 'Uma das provas de estrada mais antigas de Portugal, com percurso exigente por estradas rurais e paisagens saloias do concelho de Sintra. Data corrigida em 2026-08-18: a organização confirma 12 (não 13) de setembro.',
  },
  {
    nome: '17.ª Meia Maratona do Concelho de Castro Marim — Flor de Sal',
    dataInicio: '2026-09-12',
    local: 'Altura, Castro Marim',
    regiao: 'Algarve',
    tipo: 'Estrada',
    distancias: ['21km', '10,5km'],
    link: 'https://www.crono.aaalgarve.org/uploads/ficheiros/eventos/4f7cc90.pdf',
    desc: 'Prova algarvia noturna (partida às 20h00) junto à Pista de Atletismo de Altura, na Reserva Natural do Sapal. Data corrigida em 2026-08-18: a organização confirma 12 (não 13) de setembro.',
  },
  {
    nome: 'Meia Maratona da Benedita',
    dataInicio: '2026-09-13',
    local: 'Benedita, Alcobaça',
    regiao: 'Centro',
    tipo: 'Estrada',
    distancias: ['21km', '10km', '5km'],
    link: 'https://waitastart.com/regulamentos/reg_mmbenedita26_v3.pdf',
    desc: 'Prova organizada pelos Bombeiros Voluntários da Benedita, com meia maratona, corrida de 10 km e caminhada de 5 km no mesmo dia — boa opção para grupos com objetivos diferentes.',
  },
  {
    nome: 'Meia Maratona Loures-Odivelas-Loures',
    dataInicio: '2026-09-20',
    local: 'Odivelas',
    regiao: 'Lisboa',
    tipo: 'Estrada',
    distancias: ['21km', '10km', '5km'],
    link: 'https://werun.pt/eventos/meia-maratona-loures-odivelas-loures-2026/',
    desc: 'Prova conjunta dos municípios de Loures e Odivelas, com percurso certificado pela World Athletics — recupera uma ligação entre as duas cidades que existia nos anos 80 e 90.',
  },
  {
    nome: 'Meia Maratona do Ameal',
    dataInicio: '2026-09-27',
    local: 'Coimbra',
    regiao: 'Centro',
    tipo: 'Estrada',
    distancias: ['21km', '10,3km'],
    link: 'https://stopandgo.net/events/meia-maratona-do-ameal-arte-e-meios-2026',
    desc: 'Uma das meias maratonas mais rápidas do país, com apenas 66 metros de desnível positivo acumulado nos 21,0975 km entre Taveiro, Ameal e Arzila — homologada pela FPA e certificada pela World Athletics.',
  },
  {
    nome: 'Meia-Maratona Cidade de Ovar',
    dataInicio: '2026-10-04',
    local: 'Ovar',
    regiao: 'Norte',
    tipo: 'Estrada',
    distancias: ['21km', '10km'],
    link: 'https://mmovar.afis.pt/',
    desc: '36.ª edição de uma das provas mais consolidadas do calendário nacional, integrada no Global Calendar da World Athletics e no Circuito Estrelas de Portugal.',
  },
  {
    nome: 'Meia Maratona de Leiria',
    dataInicio: '2026-10-18',
    local: 'Leiria',
    regiao: 'Centro',
    tipo: 'Estrada',
    distancias: ['21km', '10km', '5km'],
    link: 'https://waitastart.com/regulamentos/reg_mmleiria26.pdf',
    desc: 'Meia maratona com reconhecimento nacional e internacional, a par de uma corrida de 10 km e caminhada de 5 km — boa opção para famílias e grupos com objetivos diferentes.',
  },
  {
    nome: 'Generali Tranquilidade Meia Maratona dos Descobrimentos',
    dataInicio: '2026-11-29',
    local: 'Belém, Lisboa',
    regiao: 'Lisboa',
    tipo: 'Estrada',
    distancias: ['21km', '10km', '4km'],
    link: 'https://meiamaratonadosdescobrimentos.com/',
    desc: 'Prova ponto a ponto entre a Praça do Império e o Museu da Marinha, junto ao Tejo — um dos grandes fins de festa do calendário de outono em Lisboa.',
  },
  {
    nome: 'Gerês Extreme Marathon — Meia Maratona',
    dataInicio: '2026-11-27',
    dataFim: '2026-11-29',
    local: 'Vila do Gerês, Terras de Bouro',
    regiao: 'Norte',
    tipo: 'Estrada',
    distancias: ['21km', '42km', '90km', '14km', '12km'],
    link: 'https://carlossanatureevents.com/gema',
    desc: 'Evento de estrada em ambiente de montanha dentro do Parque Nacional da Peneda-Gerês, com formato de semi-autonomia — a meia maratona (21 km) parte às 09h15 de domingo, dia 29.',
  },
  {
